...
| Feature | Phase | Match Rate | Archived At |
|---------|-------|:----------:|-------------|
...
- Design: `phase5-design-system/phase5-design-system.design.md`
- Analysis: `phase5-design-system/phase5-design-system.analysis.md`
- Report: `phase5-design-system/phase5-design-system.report.md`

## phase6-ui-integration
- Plan: `phase6-ui-integration/phase6-ui-integration.plan.md`
